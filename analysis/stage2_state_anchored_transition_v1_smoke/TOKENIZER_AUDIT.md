...
Result: PASS (12 synthetic cases). Covered HOLD, both CHANGE directions, both RETURN compositions, 3/4-transition compression, left/right boundary ownership, and strict-before first-onset state.
