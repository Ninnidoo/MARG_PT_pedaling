...
```json
{
  "class_weighting": "global_train_pedal1_4_inverse_sqrt",
  "class_weights": [
    7.744498259645563e-08,
    1.0073293865216601e-07,
    9.412690314645227e-08,
    1.4324125001344285e-07,
    6.415830444576982e-08
  ],
  "classes": 5,
  "ignore_index": -100,
  "label_smoothing": 0.0,
...
```json
{
  ...
  "final": {
    ...
    "ce_loss": 0.030625710263848305,
    "decoded_mae_gap": 0.089111328125,
    "exact_note_accuracy": 0.9921875,
    "per_class_recall": {
      "FULL": 0.9912935323383084,
      "HIGH": 0.9939246658566221,
      "LOW": 0.9997598463016331,
      "MID": 1.0,
      "ZERO": 0.9166666666666666
    },
    ...
    "representative_decoded_mae": 10.027099609375,
    "target_class_counts": [
      84,
      4164,
      2317,
  ...
  "passed": true,
  "peak_gpu_memory_bytes": 2497611776,
...
{
  "best_epoch": 3,
  "best_validation_loss": 1.2583196687344496,
  "completed_epoch": 7,
  "early_stopped": true,
  ...
  "runtime_seconds": 1808.7985238544643,
  "stop_reason": "early_stopping",
  "train_performance_count": 892,
  "train_piece_count": 180,
  "training_end_time_kst": "2026-08-07T11:41:27.791932+09:00",
  "training_end_time_utc": "2026-08-07T02:41:27.791923+00:00",
  "training_start_time_kst": "2026-08-07T11:10:14.388955+09:00",
  "training_start_time_utc": "2026-08-07T02:10:14.388941+00:00",
  "validation_performance_count": 71,
  "validation_piece_count": 19
}
```
...
- Best epoch: `3`
- Best validation five-class CE: `1.2583196687344496`
...
```json
{
  "five_class_exact_note_accuracy": 0.4588945084669353,
  "five_class_macro_f1": 0.3685682152151021,
  "five_class_micro_f1": 0.5533541954298273,
  "five_class_token_accuracy": 0.5533541954298273,
  "five_class_weighted_f1": 0.5277668755383573,
  "predicted_full_ratio": 0.5192143782930884,
  "predicted_high_ratio": 0.0020137147445831336,
  "predicted_low_ratio": 0.11576438392831985,
  "predicted_mid_ratio": 0.13548593305345016,
  "predicted_zero_ratio": 0.22752158998055846
}
```
...
```json
{
  ...
  "exact_note_accuracy": 0.4588945084669353,
  "f1": [
    0.5365091588385602,
    0.26033692932502767,
    0.2893612358935028,
    0.010292225693806285,
    0.7463415263246134
  ],
  "full_recall": 0.816924925990756,
  "high_recall": 0.005294473578055668,
  "high_to_mid_count": 17152,
  "high_to_mid_rate": 0.21621621621621623,
  "low_recall": 0.25427305491700447,
  "low_to_mid_count": 22555,
  "low_to_mid_rate": 0.16356173721346784,
  "low_to_zero_count": 54350,
  "low_to_zero_rate": 0.3941290364687199,
  "macro_f1": 0.3685682152151021,
  "macro_precision": 0.3950914423930165,
  "macro_recall": 0.37884956103186135,
  "micro_f1": 0.5533541954298273,
  "micro_precision": 0.5533541954298273,
  "micro_recall": 0.5533541954298273,
  "mid_high_full_aggregate_recall": 0.853056407107904,
  "mid_recall": 0.30577968174483144,
  "mid_to_high_count": 706,
  "mid_to_high_rate": 0.005108871055278564,
  "nonendpoint_endpoint_collapse_ratio": 0.5859776375985459,
  "precision": [
    0.5635122426944377,
    0.2666970907016543,
    0.27461607949412825,
  ...
  "token_accuracy": 0.5533541954298273,
  "valid_note_count": 283928,
  "weighted_f1": 0.5277668755383573,
  "weighted_precision": 0.5196990914177299,
  "weighted_recall": 0.5533541954298273,
  "zero_low_aggregate_recall": 0.6749654873564144,
  "zero_recall": 0.5119756689286593,
  "zero_to_low_count": 50019,
  "zero_to_low_rate": 0.1758693435533209
}
```
...
```json
{
  "on_region_depth_class_accuracy": 0.6276620647796547,
  "on_region_macro_f1": 0.3894954002548001,
  "on_region_per_class_f1": {
    "FULL": 0.8147233440059208,
    "HIGH": 0.01031168289119947,
    "MID": 0.3434511738672801
  },
  "state": {
    "accuracy": 0.7868341621819617,
    "balanced_accuracy": 0.7640109472321592,
    "confusion_matrix": [
      [
        285044,
        137265
    ...
    "macro_f1": 0.768007942686765,
    "off_f1": 0.7019206262628004,
    "off_precision": 0.7311182587194838,
    "off_recall": 0.6749654873564144,
    "off_support": 422309,
    "on_f1": 0.8340952591107295,
    "on_precision": 0.815958693442812,
    "on_recall": 0.853056407107904,
    "on_support": 713403,
    "predicted_off_count": 389874,
    "predicted_on_count": 745838
  },
  "zero_vs_nonzero": {
    "accuracy": 0.7784764095122707,
    "balanced_accuracy": 0.6897434229628883,
    "confusion_matrix": [
      [
        738514,
        112788
    ...
    "macro_f1": 0.695483314562733,
    "off_f1": 0.8544574702869059,
    "off_precision": 0.8417907861846342,
    "off_recall": 0.8675111769971173,
    "off_support": 851302,
    "on_f1": 0.5365091588385602,
    "on_precision": 0.5635122426944377,
    "on_recall": 0.5119756689286593,
    "on_support": 284410,
    "predicted_off_count": 877313,
    "predicted_on_count": 258399
  }
}
```
...
```json
{
  "combined_binary_transition": {
    "f1": 0.1254287322268591,
    "precision": 0.09714135333399125,
    "predicted_count": 60798,
    "recall": 0.17695880149812734,
    "true_count": 33375,
    "true_positive": 5906
  },
  "off_to_on_transition": {
    "f1": 0.10502176451852638,
    "precision": 0.08131658555833224,
    "predicted_count": 30412,
    "recall": 0.14823472996463466,
    "true_count": 16683,
    "true_positive": 2473
  },
  "on_to_off_transition": {
    "f1": 0.08908619737456985,
    "precision": 0.06901204502073323,
    "predicted_count": 30386,
    "recall": 0.12562904385334292,
    "true_count": 16692,
    "true_positive": 2097
  },
  "short_repedal_like": {
    ...
    "f1": 0.042106047620822,
    "precision": 0.02776958615944166,
    "predicted_count": 20346,
    "recall": 0.08704359882914806,
    "sample_based_not_milliseconds": true,
    "true_count": 6491,
    "true_positive": 565
  },
  "steady_position_state_accuracy": 0.7942347854329173,
  "steady_position_state_count": 1102266,
  "transition_direction_accuracy": 0.13692883895131086,
  "transition_timing_sample_offset": {
    ...
    "plus_minus_1_samples": {
      "combined": {
        "f1": 0.20778779480318138,
        "matched_count": 9784,
        "maximum_absolute_offset": 1,
        "mean_absolute_offset": 0.5329108748977923,
        "mean_signed_offset": -0.03413736713000818,
        "median_absolute_offset": 1.0,
        "precision": 0.16092634626139019,
        "predicted_count": 60798,
        "recall": 0.2931535580524345,
        "true_count": 33375
      },
      "off_to_on": {
        "f1": 0.23348550801571294,
        "matched_count": 5498,
        "precision": 0.18078390109167433,
        "predicted_count": 30412,
        "recall": 0.32955703410657555,
        "true_count": 16683
      },
      "on_to_off": {
        "f1": 0.1820808020731552,
        "matched_count": 4286,
        "precision": 0.14105180017113145,
        "predicted_count": 30386,
        "recall": 0.25676971004073806,
        "true_count": 16692
      }
    },
    "plus_minus_2_samples": {
      "combined": {
        "f1": 0.26604228388179196,
        "matched_count": 12527,
        "maximum_absolute_offset": 2,
        "mean_absolute_offset": 0.9061227748064181,
        "mean_signed_offset": -0.1056118783427796,
        "median_absolute_offset": 1.0,
        "precision": 0.20604296193953747,
        "predicted_count": 60798,
        "recall": 0.37534082397003743,
        "true_count": 33375
      },
      "off_to_on": {
        "f1": 0.29412888841702944,
        "matched_count": 6926,
        "precision": 0.22773905037485204,
        "predicted_count": 30412,
        "recall": 0.41515314991308516,
        "true_count": 16683
      },
      "on_to_off": {
        "f1": 0.23794553719359363,
        "matched_count": 5601,
        "precision": 0.18432830908971237,
        "predicted_count": 30386,
        "recall": 0.33554996405463694,
        "true_count": 16692
      }
    },
    "plus_minus_4_samples": {
      "combined": {
        "f1": 0.32845932485956697,
        "matched_count": 15466,
        "maximum_absolute_offset": 4,
        "mean_absolute_offset": 1.6834992887624467,
        "mean_signed_offset": -0.475559291348765,
        "median_absolute_offset": 1.0,
        "precision": 0.2543833678739432,
        "predicted_count": 60798,
        "recall": 0.4634007490636704,
        "true_count": 33375
      },
      "off_to_on": {
        "f1": 0.3528187705701243,
        "matched_count": 8308,
        "precision": 0.2731816388267789,
        "predicted_count": 30412,
        "recall": 0.4979919678714859,
        "true_count": 16683
      },
      "on_to_off": {
        "f1": 0.3040910828837249,
        "matched_count": 7158,
        "precision": 0.23556901204502073,
        "predicted_count": 30386,
        "recall": 0.4288281811646298,
        "true_count": 16692
      }
    }
  }
...
```json
{
  "decoded_transition_direction_accuracy": 0.14068102830032547,
  "decoded_transition_f1": 0.2156521989428955,
  "decoded_transition_precision": 0.22547079668655437,
  "decoded_transition_recall": 0.206653058972803,
  "delta_mae": 8.715395094048207,
  "error_quantiles": {
    "median": 2.0,
    "q01": 0.0,
    "q05": 0.0,
  ...
  "exact_value_transition_accuracy": 0.07326777734870635,
  "maximum_absolute_error": 127,
  "median_performance_mae": 28.77854154213987,
  "on_region_mae": 21.099604290982796,
  "overall_micro_mae": 28.65976321461779,
  "per_slot_mae": {
    "Pedal1": 28.70679538474543,
    "Pedal2": 28.75901637034741,
    "Pedal3": 28.580037896931618,
    "Pedal4": 28.593203206446706
  },
  "performance_count": 71,
  "performance_macro_mae": 27.10332876497899,
  "steady_position_decoded_accuracy": 0.5469415772870663,
  "subthreshold_region_mae": 41.50984416130646,
  "target_count": 1135712,
  "tolerance_accuracy": {
    "plus_minus_10": 0.5355142853117691,
    "plus_minus_20": 0.5821062029810374,
    "plus_minus_5": 0.5153119805020991
  },
  "zero_target_mae": 41.39288351323793
}
```
...
```json
{
  ...
  "model_minus_oracle_on_region_mae": 18.502499989487006,
  "model_minus_oracle_overall_mae": 25.02449300526894
}
```
...
```json
{
  ...
  "best_epoch": 3,
  "best_validation_loss": 1.2583196687344496,
  "binary_transition_f1": 0.1254287322268591,
  "binary_transition_precision": 0.09714135333399125,
  "binary_transition_recall": 0.17695880149812734,
  "canonical_decoded_delta_mae": 8.715395094048207,
  "canonical_decoded_error_median": 2.0,
  "canonical_decoded_error_q01": 0.0,
  "canonical_decoded_error_q05": 0.0,
  "canonical_decoded_error_q25": 0.0,
  "canonical_decoded_error_q75": 47.0,
  "canonical_decoded_error_q95": 127.0,
  "canonical_decoded_error_q99": 127.0,
  "canonical_decoded_exact_value_transition_accuracy": 0.07326777734870635,
  "canonical_decoded_maximum_absolute_error": 127,
  "canonical_decoded_median_performance_mae": 28.77854154213987,
  "canonical_decoded_on_region_mae": 21.099604290982796,
  "canonical_decoded_overall_mae": 28.65976321461779,
  "canonical_decoded_pedal1_mae": 28.70679538474543,
  "canonical_decoded_pedal2_mae": 28.75901637034741,
  "canonical_decoded_pedal3_mae": 28.580037896931618,
  "canonical_decoded_pedal4_mae": 28.593203206446706,
  "canonical_decoded_performance_macro_mae": 27.10332876497899,
  "canonical_decoded_steady_position_accuracy": 0.5469415772870663,
  "canonical_decoded_subthreshold_mae": 41.50984416130646,
  "canonical_decoded_tolerance_10": 0.5355142853117691,
  "canonical_decoded_tolerance_20": 0.5821062029810374,
  "canonical_decoded_tolerance_5": 0.5153119805020991,
  "canonical_decoded_transition_direction_accuracy": 0.14068102830032547,
  "canonical_decoded_transition_f1": 0.2156521989428955,
  "canonical_decoded_transition_precision": 0.22547079668655437,
  "canonical_decoded_transition_recall": 0.206653058972803,
  "canonical_decoded_zero_mae": 41.39288351323793,
  "canonical_oracle_median_performance_mae": 3.4748825352394284,
  "canonical_oracle_on_region_mae": 2.5971043014957886,
  "canonical_oracle_overall_mae": 3.635270209348849,
  "canonical_oracle_pedal1_mae": 3.654623707418782,
  ...
  "canonical_oracle_performance_macro_mae": 4.171420050076859,
  "canonical_oracle_subthreshold_mae": 16.503658474680744,
  "checkpoint": "/workspace/project/analysis/stage2_encoder_only_5class_weighted_sqrt_v0/best.pt",
  ...
  "five_class_token_accuracy": 0.5533541954298273,
  "five_class_weighted_f1": 0.5277668755383573,
  "full_f1": 0.7463415263246134,
  "full_precision": 0.6869851003428991,
  "full_predicted_count": 589678,
  "full_recall": 0.816924925990756,
  "full_support": 495884,
  "high_f1": 0.010292225693806285,
  "high_precision": 0.18364669873196326,
  "high_predicted_count": 2287,
  "high_recall": 0.005294473578055668,
  "high_support": 79328,
  "high_to_mid_count": 17152,
  "high_to_mid_rate": 0.21621621621621623,
  ...
  "low_f1": 0.26033692932502767,
  "low_precision": 0.2666970907016543,
  "low_predicted_count": 131475,
  "low_recall": 0.25427305491700447,
  "low_support": 137899,
  "low_to_mid_count": 22555,
  "low_to_mid_rate": 0.16356173721346784,
  "low_to_zero_count": 54350,
  "low_to_zero_rate": 0.3941290364687199,
  "mid_f1": 0.2893612358935028,
  "mid_high_full_aggregate_recall": 0.853056407107904,
  "mid_precision": 0.27461607949412825,
  "mid_predicted_count": 153873,
  "mid_recall": 0.30577968174483144,
  "mid_support": 138191,
  "mid_to_high_count": 706,
  "mid_to_high_rate": 0.005108871055278564,
  ...
  "nonendpoint_endpoint_collapse_ratio": 0.5859776375985459,
  "off_f1": 0.7019206262628004,
  "off_on_balanced_accuracy": 0.7640109472321592,
  "off_on_state_accuracy": 0.7868341621819617,
  "off_on_state_macro_f1": 0.768007942686765,
  "off_precision": 0.7311182587194838,
  "off_recall": 0.6749654873564144,
  "off_to_on_transition_f1": 0.10502176451852638,
  "off_to_on_transition_precision": 0.08131658555833224,
  "off_to_on_transition_predicted_count": 30412,
  "off_to_on_transition_recall": 0.14823472996463466,
  "off_to_on_transition_true_count": 16683,
  "off_to_on_transition_true_positive": 2473,
  "on_f1": 0.8340952591107295,
  "on_precision": 0.815958693442812,
  "on_recall": 0.853056407107904,
  "on_region_3way_accuracy": 0.6276620647796547,
  "on_region_macro_f1": 0.3894954002548001,
  "on_to_off_transition_f1": 0.08908619737456985,
  "on_to_off_transition_precision": 0.06901204502073323,
  "on_to_off_transition_predicted_count": 30386,
  "on_to_off_transition_recall": 0.12562904385334292,
  "on_to_off_transition_true_count": 16692,
  "on_to_off_transition_true_positive": 2097,
  "predicted_full_ratio": 0.5192143782930884,
  "predicted_high_ratio": 0.0020137147445831336,
  "predicted_low_ratio": 0.11576438392831985,
  "predicted_mid_ratio": 0.13548593305345016,
  "predicted_off_ratio": 0.34328597390887833,
  "predicted_on_ratio": 0.6567140260911217,
  "predicted_zero_ratio": 0.22752158998055846,
  "short_repedal_f1": 0.042106047620822,
  "short_repedal_precision": 0.02776958615944166,
  "short_repedal_predicted_count": 20346,
  "short_repedal_recall": 0.08704359882914806,
  "short_repedal_true_count": 6491,
  "short_repedal_true_positive": 565,
  "steady_position_state_accuracy": 0.7942347854329173,
  "target_full_ratio": 0.4366283001324279,
  "target_high_ratio": 0.06984869403510749,
  "target_low_ratio": 0.12142074751345412,
  ...
  "target_zero_ratio": 0.25042440336986843,
  "transition_direction_accuracy": 0.13692883895131086,
  "zero_f1": 0.5365091588385602,
  "zero_low_aggregate_recall": 0.6749654873564144,
  "zero_precision": 0.5635122426944377,
  "zero_predicted_count": 258399,
  "zero_recall": 0.5119756689286593,
  "zero_support": 284410,
  "zero_to_low_count": 50019,
  "zero_to_low_rate": 0.1758693435533209,
  "zero_vs_nonzero_accuracy": 0.7784764095122707
}
```
...
```json
{
  ...
  "criterion_b_checks": {
    ...
    "macro_f1_decrease_at_most_0p01": true,
    "on_region_mae_improvement_at_least_1p0": false
  },
  "deltas_new_minus_reference": {
    "binary_transition_f1": 0.05295009026524809,
    "five_class_macro_f1": -0.002813242272479477,
    "on_region_mae": 1.8717386946788857
  },
  "passed": false,
...
- ZERO/LOW separation: LOW recall=0.254273; detailed directional confusion is reported above.
- Renderer state versus depth localization: OFF/ON accuracy=0.786834, ON-region 3-way accuracy=0.627662.
- Temporal transition diagnostic: binary transition F1=0.125429 versus reference 0.072479.
- Quantization/model decomposition: oracle MAE=3.635270, model MAE=28.659763, gap=25.024493.
