...
```json
{
  ...
  "final": {
    ...
    "ce_loss": 0.020986806601285934,
    "decoded_mae_gap": 0.0233154296875,
    "exact_note_accuracy": 0.99755859375,
    "per_class_recall": {
      "FULL": 0.996268656716418,
      "HIGH": 1.0,
      "LOW": 1.0,
      "MID": 1.0,
      "ZERO": 0.9761904761904762
    },
    ...
    "representative_decoded_mae": 9.9613037109375,
    "target_class_counts": [
      84,
      4164,
      2317,
    ...
    "token_accuracy": 0.9993896484375
  },
  "gpu": {
...
{
  "best_epoch": 3,
  "best_validation_loss": 1.2340312112461438,
  "completed_epoch": 7,
  "early_stopped": true,
  ...
  "runtime_seconds": 1811.093561694026,
  "stop_reason": "early_stopping",
  "train_performance_count": 892,
  "train_piece_count": 180,
  "training_end_time_kst": "2026-08-07T14:26:52.171007+09:00",
  "training_end_time_utc": "2026-08-07T05:26:52.170998+00:00",
  "training_start_time_kst": "2026-08-07T13:55:36.707744+09:00",
  "training_start_time_utc": "2026-08-07T04:55:36.707738+00:00",
  "validation_performance_count": 71,
  "validation_piece_count": 19
}
```
...
- Best epoch: `3`
- Best validation five-class CE: `1.2340312112461438`
...
```json
{
  "five_class_exact_note_accuracy": 0.4858978332535009,
  "five_class_macro_f1": 0.3634246297618995,
  "five_class_micro_f1": 0.5708454256008566,
  "five_class_token_accuracy": 0.5708454256008566,
  "five_class_weighted_f1": 0.5301554394976533,
  "predicted_full_ratio": 0.5329273618663887,
  "predicted_high_ratio": 0.009859894057648418,
  "predicted_low_ratio": 0.06458855766250599,
  "predicted_mid_ratio": 0.08990395452368206,
  "predicted_zero_ratio": 0.30272023188977487
}
```
...
```json
{
  ...
  "exact_note_accuracy": 0.4858978332535009,
  "f1": [
    0.5819554832516998,
    0.18925175027100208,
    0.2547857642241236,
    0.040872235600821864,
    0.7502579154618503
  ],
  "full_recall": 0.8329932000225859,
  "high_recall": 0.02332089552238806,
  "high_to_mid_count": 11352,
  "high_to_mid_rate": 0.14310205728116177,
  "low_recall": 0.14496116723108943,
  "low_to_mid_count": 15979,
  "low_to_mid_rate": 0.11587466189022401,
  "low_to_zero_count": 73841,
  "low_to_zero_rate": 0.5354716132821847,
  "macro_f1": 0.3634246297618995,
  "macro_precision": 0.3903384325940851,
  "macro_recall": 0.37310295415843653,
  "micro_f1": 0.5708454256008566,
  "micro_precision": 0.5708454256008566,
  "micro_recall": 0.5708454256008566,
  "mid_high_full_aggregate_recall": 0.8358921955752919,
  "mid_recall": 0.22151949113907562,
  "mid_to_high_count": 3451,
  "mid_to_high_rate": 0.024972682736212923,
  "nonendpoint_endpoint_collapse_ratio": 0.7118238243420423,
  "precision": [
    0.5316882051640038,
    0.2725141096600049,
    0.29980902012634053,
  ...
  "token_accuracy": 0.5708454256008566,
  "valid_note_count": 283928,
  "weighted_f1": 0.5301554394976533,
  "weighted_precision": 0.5122431740250922,
  "weighted_recall": 0.5708454256008566,
  "zero_low_aggregate_recall": 0.7105744845598839,
  "zero_recall": 0.6427200168770437,
  "zero_to_low_count": 23455,
  "zero_to_low_rate": 0.0824689708519391
}
```
...
```json
{
  "on_region_depth_class_accuracy": 0.62451377412206,
  "on_region_macro_f1": 0.3833690032574557,
  "on_region_per_class_f1": {
    "FULL": 0.8184985896598836,
    "HIGH": 0.041356492969396204,
    "MID": 0.2902519271430874
  },
  "state": {
    "accuracy": 0.789293412414415,
    "balanced_accuracy": 0.7732333400675879,
    "confusion_matrix": [
      [
        300082,
        122227
    ...
    "macro_f1": 0.7739101052189711,
    "off_f1": 0.7149354470580106,
    "off_precision": 0.7193502686039069,
    "off_recall": 0.7105744845598839,
    "off_support": 422309,
    "on_f1": 0.8328847633799316,
    "on_precision": 0.8298988943087168,
    "on_recall": 0.8358921955752919,
    "on_support": 713403,
    "predicted_off_count": 417157,
    "predicted_on_count": 718555
  },
  "zero_vs_nonzero": {
    "accuracy": 0.7687609182609676,
    "balanced_accuracy": 0.7267948599953137,
    "confusion_matrix": [
      [
        690295,
        161007
    ...
    "macro_f1": 0.7110668233079953,
    "off_f1": 0.8401781633642909,
    "off_precision": 0.8716847516570717,
    "off_recall": 0.8108697031135836,
    "off_support": 851302,
    "on_f1": 0.5819554832516998,
    "on_precision": 0.5316882051640038,
    "on_recall": 0.6427200168770437,
    "on_support": 284410,
    "predicted_off_count": 791909,
    "predicted_on_count": 343803
  }
}
```
...
```json
{
  "combined_binary_transition": {
    "f1": 0.12942971923603475,
    "precision": 0.10346436068103124,
    "predicted_count": 55739,
    "recall": 0.1727940074906367,
    "true_count": 33375,
    "true_positive": 5767
  },
  "off_to_on_transition": {
    "f1": 0.11277908672725231,
    "precision": 0.0901298328670827,
    "predicted_count": 27882,
    "recall": 0.150632380267338,
    "true_count": 16683,
    "true_positive": 2513
  },
  "on_to_off_transition": {
    "f1": 0.09167433612426766,
    "precision": 0.073302940015077,
    "predicted_count": 27857,
    "recall": 0.1223340522405943,
    "true_count": 16692,
    "true_positive": 2042
  },
  "short_repedal_like": {
    ...
    "f1": 0.044601421002915934,
    "precision": 0.03040654048605667,
    "predicted_count": 17858,
    "recall": 0.08365429055615467,
    "sample_based_not_milliseconds": true,
    "true_count": 6491,
    "true_positive": 543
  },
  "steady_position_state_accuracy": 0.7967042438032199,
  "steady_position_state_count": 1102266,
  "transition_direction_accuracy": 0.13647940074906367,
  "transition_timing_sample_offset": {
    ...
    "plus_minus_1_samples": {
      "combined": {
        "f1": 0.2146464079718114,
        "matched_count": 9564,
        "maximum_absolute_offset": 1,
        "mean_absolute_offset": 0.5237348389795065,
        "mean_signed_offset": -0.01369719782517775,
        "median_absolute_offset": 1.0,
        "precision": 0.1715854249268914,
        "predicted_count": 55739,
        "recall": 0.286561797752809,
        "true_count": 33375
      },
      "off_to_on": {
        "f1": 0.24418265454953442,
        "matched_count": 5441,
        "precision": 0.19514382038591205,
        "predicted_count": 27882,
        "recall": 0.3261403824252233,
        "true_count": 16683
      },
      "on_to_off": {
        "f1": 0.18509955330085973,
        "matched_count": 4123,
        "precision": 0.148005887209678,
        "predicted_count": 27857,
        "recall": 0.24700455307931943,
        "true_count": 16692
      }
    },
    "plus_minus_2_samples": {
      "combined": {
        "f1": 0.2752429472361246,
        "matched_count": 12264,
        "maximum_absolute_offset": 2,
        "mean_absolute_offset": 0.889921722113503,
        "mean_signed_offset": -0.07012393998695368,
        "median_absolute_offset": 1.0,
        "precision": 0.2200254758786487,
        "predicted_count": 55739,
        "recall": 0.3674606741573034,
        "true_count": 33375
      },
      "off_to_on": {
        "f1": 0.30683271625715247,
        "matched_count": 6837,
        "precision": 0.24521196470841403,
        "predicted_count": 27882,
        "recall": 0.4098183779895702,
        "true_count": 16683
      },
      "on_to_off": {
        "f1": 0.24364183258883482,
        "matched_count": 5427,
        "precision": 0.19481638367376242,
        "predicted_count": 27857,
        "recall": 0.3251258087706686,
        "true_count": 16692
      }
    },
    "plus_minus_4_samples": {
      "combined": {
        "f1": 0.3408891981057971,
        "matched_count": 15189,
        "maximum_absolute_offset": 4,
        "mean_absolute_offset": 1.649614852854039,
        "mean_signed_offset": -0.4126670616893805,
        "median_absolute_offset": 1.0,
        "precision": 0.27250219774305245,
        "predicted_count": 55739,
        "recall": 0.45510112359550564,
        "true_count": 33375
      },
      "off_to_on": {
        "f1": 0.36818130820150347,
        "matched_count": 8204,
        "precision": 0.2942400114769385,
        "predicted_count": 27882,
        "recall": 0.49175807708445723,
        "true_count": 16683
      },
      "on_to_off": {
        "f1": 0.313587285909897,
        "matched_count": 6985,
        "precision": 0.25074487561474673,
        "predicted_count": 27857,
        "recall": 0.418463934819075,
        "true_count": 16692
      }
    }
  }
...
```json
{
  "decoded_transition_direction_accuracy": 0.1369504054724996,
  "decoded_transition_f1": 0.22129269687282943,
  "decoded_transition_precision": 0.24948300179110677,
  "decoded_transition_recall": 0.19882633640425884,
  "delta_mae": 8.379869166400297,
  "error_quantiles": {
    "median": 0.0,
    "q01": 0.0,
    "q05": 0.0,
  ...
  "exact_value_transition_accuracy": 0.0860111987642743,
  "maximum_absolute_error": 127,
  "median_performance_mae": 28.53133094241881,
  "on_region_mae": 22.675613923686893,
  "overall_micro_mae": 28.605620086782565,
  "per_slot_mae": {
    "Pedal1": 28.725345862331295,
    "Pedal2": 28.641317517117017,
    "Pedal3": 28.50721309627793,
    "Pedal4": 28.54860387140402
  },
  "performance_count": 71,
  "performance_macro_mae": 27.379785557842936,
  "steady_position_decoded_accuracy": 0.5901153312302839,
  "subthreshold_region_mae": 45.47170755407944,
  "target_count": 1135712,
  "tolerance_accuracy": {
    "plus_minus_10": 0.5659392522047844,
    "plus_minus_20": 0.6080740539855175,
    "plus_minus_5": 0.550016201290468
  },
  "zero_target_mae": 35.3025280405049
}
```
...
```json
{
  ...
  "model_minus_oracle_on_region_mae": 20.078509622191103,
  "model_minus_oracle_overall_mae": 24.970349877433716
}
```
...
```json
{
  ...
  "best_epoch": 3,
  "best_validation_loss": 1.2340312112461438,
  "binary_transition_f1": 0.12942971923603475,
  "binary_transition_precision": 0.10346436068103124,
  "binary_transition_recall": 0.1727940074906367,
  "canonical_decoded_delta_mae": 8.379869166400297,
  "canonical_decoded_error_median": 0.0,
  "canonical_decoded_error_q01": 0.0,
  "canonical_decoded_error_q05": 0.0,
  "canonical_decoded_error_q25": 0.0,
  ...
  "canonical_decoded_error_q95": 127.0,
  "canonical_decoded_error_q99": 127.0,
  "canonical_decoded_exact_value_transition_accuracy": 0.0860111987642743,
  "canonical_decoded_maximum_absolute_error": 127,
  "canonical_decoded_median_performance_mae": 28.53133094241881,
  "canonical_decoded_on_region_mae": 22.675613923686893,
  "canonical_decoded_overall_mae": 28.605620086782565,
  "canonical_decoded_pedal1_mae": 28.725345862331295,
  "canonical_decoded_pedal2_mae": 28.641317517117017,
  "canonical_decoded_pedal3_mae": 28.50721309627793,
  "canonical_decoded_pedal4_mae": 28.54860387140402,
  "canonical_decoded_performance_macro_mae": 27.379785557842936,
  "canonical_decoded_steady_position_accuracy": 0.5901153312302839,
  "canonical_decoded_subthreshold_mae": 45.47170755407944,
  "canonical_decoded_tolerance_10": 0.5659392522047844,
  "canonical_decoded_tolerance_20": 0.6080740539855175,
  "canonical_decoded_tolerance_5": 0.550016201290468,
  "canonical_decoded_transition_direction_accuracy": 0.1369504054724996,
  "canonical_decoded_transition_f1": 0.22129269687282943,
  "canonical_decoded_transition_precision": 0.24948300179110677,
  "canonical_decoded_transition_recall": 0.19882633640425884,
  "canonical_decoded_zero_mae": 35.3025280405049,
  "canonical_oracle_median_performance_mae": 3.4748825352394284,
  "canonical_oracle_on_region_mae": 2.5971043014957886,
  "canonical_oracle_overall_mae": 3.635270209348849,
  "canonical_oracle_pedal1_mae": 3.654623707418782,
  ...
  "canonical_oracle_performance_macro_mae": 4.171420050076859,
  "canonical_oracle_subthreshold_mae": 16.503658474680744,
  "checkpoint": "/workspace/project/analysis/stage2_encoder_only_5class_weighted_sqrt_probability_v0/best.pt",
  ...
  "five_class_token_accuracy": 0.5708454256008566,
  "five_class_weighted_f1": 0.5301554394976533,
  "full_f1": 0.7502579154618503,
  "full_precision": 0.682472755149921,
  "full_predicted_count": 605252,
  "full_recall": 0.8329932000225859,
  "full_support": 495884,
  "high_f1": 0.040872235600821864,
  "high_precision": 0.16520807287015538,
  "high_predicted_count": 11198,
  "high_recall": 0.02332089552238806,
  "high_support": 79328,
  "high_to_mid_count": 11352,
  "high_to_mid_rate": 0.14310205728116177,
  ...
  "low_f1": 0.18925175027100208,
  "low_precision": 0.2725141096600049,
  "low_predicted_count": 73354,
  "low_recall": 0.14496116723108943,
  "low_support": 137899,
  "low_to_mid_count": 15979,
  "low_to_mid_rate": 0.11587466189022401,
  "low_to_zero_count": 73841,
  "low_to_zero_rate": 0.5354716132821847,
  "mid_f1": 0.2547857642241236,
  "mid_high_full_aggregate_recall": 0.8358921955752919,
  "mid_precision": 0.29980902012634053,
  "mid_predicted_count": 102105,
  "mid_recall": 0.22151949113907562,
  "mid_support": 138191,
  "mid_to_high_count": 3451,
  "mid_to_high_rate": 0.024972682736212923,
  ...
  "nonendpoint_endpoint_collapse_ratio": 0.7118238243420423,
  "off_f1": 0.7149354470580106,
  "off_on_balanced_accuracy": 0.7732333400675879,
  "off_on_state_accuracy": 0.789293412414415,
  "off_on_state_macro_f1": 0.7739101052189711,
  "off_precision": 0.7193502686039069,
  "off_recall": 0.7105744845598839,
  "off_to_on_transition_f1": 0.11277908672725231,
  "off_to_on_transition_precision": 0.0901298328670827,
  "off_to_on_transition_predicted_count": 27882,
  "off_to_on_transition_recall": 0.150632380267338,
  "off_to_on_transition_true_count": 16683,
  "off_to_on_transition_true_positive": 2513,
  "on_f1": 0.8328847633799316,
  "on_precision": 0.8298988943087168,
  "on_recall": 0.8358921955752919,
  "on_region_3way_accuracy": 0.62451377412206,
  "on_region_macro_f1": 0.3833690032574557,
  "on_to_off_transition_f1": 0.09167433612426766,
  "on_to_off_transition_precision": 0.073302940015077,
  "on_to_off_transition_predicted_count": 27857,
  "on_to_off_transition_recall": 0.1223340522405943,
  "on_to_off_transition_true_count": 16692,
  "on_to_off_transition_true_positive": 2042,
  "predicted_full_ratio": 0.5329273618663887,
  "predicted_high_ratio": 0.009859894057648418,
  "predicted_low_ratio": 0.06458855766250599,
  "predicted_mid_ratio": 0.08990395452368206,
  "predicted_off_ratio": 0.36730878955228086,
  "predicted_on_ratio": 0.6326912104477191,
  "predicted_zero_ratio": 0.30272023188977487,
  "short_repedal_f1": 0.044601421002915934,
  "short_repedal_precision": 0.03040654048605667,
  "short_repedal_predicted_count": 17858,
  "short_repedal_recall": 0.08365429055615467,
  "short_repedal_true_count": 6491,
  "short_repedal_true_positive": 543,
  "steady_position_state_accuracy": 0.7967042438032199,
  "target_full_ratio": 0.4366283001324279,
  "target_high_ratio": 0.06984869403510749,
  "target_low_ratio": 0.12142074751345412,
  ...
  "target_zero_ratio": 0.25042440336986843,
  "transition_direction_accuracy": 0.13647940074906367,
  "zero_f1": 0.5819554832516998,
  "zero_low_aggregate_recall": 0.7105744845598839,
  "zero_precision": 0.5316882051640038,
  "zero_predicted_count": 343803,
  "zero_recall": 0.6427200168770437,
  "zero_support": 284410,
  "zero_to_low_count": 23455,
  "zero_to_low_rate": 0.0824689708519391,
  "zero_vs_nonzero_accuracy": 0.7687609182609676
}
```
...
```json
{
  ...
  "deltas_new_minus_reference": {
    "binary_transition_f1": 0.056951077274423736,
    "five_class_macro_f1": -0.00795682772568207,
    "on_region_mae": 3.447748327382982
  },
  "passed": false,
...
- ZERO/LOW separation: LOW recall=0.144961; detailed directional confusion is reported above.
- Renderer state versus depth localization: OFF/ON accuracy=0.789293, ON-region 3-way accuracy=0.624514.
- Temporal transition diagnostic: binary transition F1=0.129430 versus reference 0.072479.
- Quantization/model decomposition: oracle MAE=3.635270, model MAE=28.605620, gap=24.970350.
